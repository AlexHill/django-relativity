    ...
    for state_app_label, state_model in state.models:
        for _, f in state.models[state_app_label, state_model].fields:
            if (f.related_model and
                ...
                if (field.primary_key and f.to_fields[0] is None) or field_name in f.to_fields:
                    return True
    return False


django.db.migrations.operations.fields.is_referenced_by_foreign_key = is_referenced_by_foreign_key
