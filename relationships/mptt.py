...
class MPTTRef(L):
    def resolve_expression(self, query=None, allow_joins=True, reuse=None, summarize=False, for_save=False):
        ...
        return L(name).resolve_expression(query, allow_joins, reuse, summarize, for_save)
...
class MPTTQ(Q):
    ...
    def resolve_expression(self, query=None, allow_joins=True, reuse=None, summarize=False, for_save=False):
        ...
        return clone_q.resolve_expression(query, allow_joins, reuse, summarize, for_save)
